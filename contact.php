...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-8">				
				<div class="panel panel-primary">
					<div class="panel panel-body">
						...
						<h5>Location: Sunkoshi Gaupalika, Ramtar, Sindhuli, Bagmati Pradesh, Nepal</h5>
						<h5>Telephone: +977-1-6924118</h5>
						<h5>Email: info@sunkoshimunsindhuli.gov.np</h5>
						<h5>Website: www.sunkoshimunsindhuli.gov.np</h5>
      ...
      <div class="form-group">
        <label for="fname">Fulll Name:</label>
